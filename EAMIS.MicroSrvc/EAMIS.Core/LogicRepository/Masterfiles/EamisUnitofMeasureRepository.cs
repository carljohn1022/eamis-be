...
namespace EAMIS.Core.LogicRepository.Masterfiles
{
    public class EamisUnitofMeasureRepository : IEamisUnitofMeasureRepository
    {
        ...
        public Task<bool> ValidateExistingCode(string description, string shortDescription)
        {
            return _ctx.EAMIS_UNITOFMEASURE.AsNoTracking().AnyAsync(x => x.UOM_DESCRIPTION == description && x.SHORT_DESCRIPTION == shortDescription);
        }
        public Task<bool> UpdateValidateExistingCode(string description,string shortDescription, int id)
        {
            return _ctx.EAMIS_UNITOFMEASURE.AsNoTracking().AnyAsync(x => x.UOM_DESCRIPTION == description && x.SHORT_DESCRIPTION == shortDescription && x.ID == id);
        }
