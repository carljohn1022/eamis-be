...
namespace EAMIS.Core.ContractRepository.Masterfiles
{
    public interface IEamisUnitofMeasureRepository
    {
        ...
        Task<bool> ValidateExistingCode(string decription,string shortDescription);
        Task<bool> UpdateValidateExistingCode(string decription, string shortDescription, int id);
    }
}
