...
namespace EAMIS.Core.ContractRepository.Transaction
{
    public interface IEamisPropertyTransferDetailsRepository
    {
        ...
        Task<DataList<EamisPropertyTransferDetailsDTO>> ListItemsForTranser(EamisPropertyTransferDetailsDTO filter, string tranType, PageConfig config, string branchID);
