...
namespace EAMIS.WebApi.Controllers.Transaction
{
    ...
    public class EamisPropertyTransactionController : ControllerBase
    {
        ...
        public EamisPropertyTransactionController(IEamisPropertyTransactionRepository eamisPropertyTransactionRepository, IEamisDeliveryReceiptDetailsRepository eamisDeliveryReceiptDetailsRepository, IEamisAttachedFilesRepository eamisAttachedFilesRepository, IWebHostEnvironment hostingEnvironment)
        {
