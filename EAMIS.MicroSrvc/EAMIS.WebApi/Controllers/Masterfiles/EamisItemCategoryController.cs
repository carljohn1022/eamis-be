...
namespace EAMIS.WebApi.Controllers.Masterfiles
{
    ...
    public class EamisItemCategoryController : ControllerBase
    {
        ...
        public async Task<ActionResult<EAMISITEMCATEGORY>> SearchItemCategory(string type, string searchValue)
        {
            return Ok(await _eamisItemCategoryRepository.SearchItemCategory(type, searchValue));
        }
