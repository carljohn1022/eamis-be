...
namespace EAMIS.WebApi.Controllers.Masterfiles
{
    ...
    public class EamisItemSubCategoryController : ControllerBase
    {
        ...
        public async Task<ActionResult<EAMISITEMSUBCATEGORY>> SearchItemSubCategory(string searchValue)
        {
            return Ok(await _eamisItemSubCategoryRepository.SearchItemSubCategory(searchValue));
        }
